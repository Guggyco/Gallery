...
class CameraController: UIViewController {
    ...
    func setup() {
        ...
        cameraView.memeButton.addTarget(self, action: #selector(memeButtonTouched(_:)), for: .touchUpInside)
    }
    ...
    @objc func memeButtonTouched(_ button: UIButton) {
        EventHub.shared.createMeme?()
    }
